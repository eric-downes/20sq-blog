...
Yet, for the sake of the argument I will take for granted Vitalik's estimate. Let's do some simple calculations. I will interpret 'between 10 and 20 years' in statistical terms as a normal distribution of mean $\mu = 15$ and standard deviation $\sigma = 3$. 
