...
\scalebox{1}{
    ...
    \begin{tikzpicture}[x={({cos(-10)*1cm},{sin(-10)*1cm})},y={({cos(45)*1cm},{sin(45)*1cm})},z={(0,1cm)}]
        ...
        \node[purple] (3) at (3.2,4.2) {$\Xi 0.8$};
        \node[purple] (4) at (2.5,3) {$\Xi 0.3$};
        \node[purple] (5) at (3.5,3.5) {$\Xi 0.6$};
        \node[purple] (6) at (5.2,5.2) {$\Xi 0.2$};
        \end{scope}
        ...
        \draw[dashed] (3.2,4.2,0.5) -- (3.2,4.2,2);
        \draw[dashed] (2.5,3,0.5) -- (2.5,3,2);
        \draw[dashed] (3.5,3.5,0.5) -- (3.5,3.5,2);
        \draw[dashed] (5.2,5.2,0.5) -- (5.2,5.2,2);
\end{tikzpicture}}}
\end{document}