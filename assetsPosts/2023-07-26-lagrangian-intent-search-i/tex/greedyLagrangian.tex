...
\scalebox{1}{
    ...
    \begin{tikzpicture}[x={({cos(-10)*1cm},{sin(-10)*1cm})},y={({cos(45)*1cm},{sin(45)*1cm})},z={(0,1cm)}]
        ...
        \draw[dashed, very thin] (5,5,0) -- (5,5,1);
        ...
        \begin{scope}[canvas is xy plane at z=3.1]
            ...
            \node[purple] (3) at (3.2,4.2) {$0.0$};
            \node[purple] (4) at (2.5,3) {$3.5$};
            \node[purple] (5) at (3.5,3.5) {$-2.0$};
            \node[purple] (6) at (5.2,5.2) {$0.0$};
        \end{scope}
        ...
        \draw[dashed, very thin] (3.2,4.2,0.5) -- (3.2,4.2,3);
        \draw[dashed, very thin] (2.5,3,0.5) -- (2.5,3,3);
        \draw[dashed, very thin] (3.5,3.5,0.5) -- (3.5,3.5,3);
        \draw[dashed, very thin] (5.2,5.2,0.5) -- (5.2,5.2,3);

        
        %\draw[dashed] (2,2,1) -- (1,0,2);
        %\draw[dashed] (2,0,2) -- (2,0,2);
        %\draw[dashed] (3,4,2) -- (3,4,2);
        %\draw[dashed] (4,3,2) -- (4,3,2);
        %\draw[dashed] (5,5,2) -- (5,5,2);
    \end{tikzpicture}}}
\end{document}
